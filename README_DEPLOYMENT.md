# AI Gym - Deployment Guide

## Overview
Multi-exercise, age-adaptive AI fitness trainer with backend API.

## Features
- 3 Exercise Types: Bicep, Back, Chest
- 3 Age Groups: Children (8-15), Adults (16-59), Seniors (60+)
